    ...
    <header class="h-16 border-b border-gray-300 bg-white px-6">
        <div class="flex h-full items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <!-- Profile-->
                <NuxtLink to="/profile" 
                class="hidden rounded-lg px-3 py-2 text-sm font-medium text-gray-600 transition hover:bg-gray-100 hover:text-gray-900 sm:block">
                    Profile
                </NuxtLink>

                <!-- Logout -->
                <button type="button" @click="authStore.logout()" 
                class="hidden rounded-lg px-3 py-2 text-sm font-medium text-red-600 transition bg-red-100 hover:bg-red-500 hover:text-white sm:block">
                    Logout
                </button>
            </div>
        </div>
